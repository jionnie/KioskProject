...
public class MenuRepository {
    ...
    public MenuRepository() {
        Menu burgers = createBurgerMenu();
        Menu drinks = createDrinkMenu();
        Menu desserts = createDessertMenu();
     ...
     * 버거 메뉴를 생성하는 메소드
     * 
     * @return burgers 버거 MenuItem을 가지는 Menu 객체
     */
     ...
     * 음료 메뉴를 생성하는 메소드
     *
     * @return drinks 음료 MenuItem을 가지는 Menu 객체
     */
     ...
     * 디저트 메뉴를 생성하는 메소드
     *
     * @return desserts 디저트 MenuItem을 가지는 Menu 객체
     */
    private Menu createDessertMenu() {
